...
async def run_migrations_online() -> None:
    """Run migrations using the service's async engine.

    Alembic itself drives migrations synchronously; `connection.run_sync`
    bridges that onto our async engine/driver (asyncpg) rather than
    requiring a second, sync-only database driver just for migrations.
    """
